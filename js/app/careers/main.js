...
define("main",["json!app/modules/routes.json","app/common/lib/Routes",'hoganTemplateEngine',"app/careers/vms/CareersVM","jquery","app/common/lib/env","require"],function(routes,Routes,hogan,CareersVM,$,env,require){
    'use strict';
    console.log("I have loaded this",$('head title')[0],CareersVM,window.location.host,env);
    ...
    var data=require(["json!"+dataUrl],function(data) {
        data.env=env
        console.log("data",data)
        ko.applyBindings(new CareersVM(data),document.getElementById("careersPage"));
    })
})
