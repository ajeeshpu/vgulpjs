...
(function(e, t) {
    var n, r, i = typeof t, o = e.document, a = e.location, s = e.jQuery, u = e.$, l = {}, c = [], p = "1.9.1", f = c.concat, d = c.push, h = c.slice, g = c.indexOf, m = l.toString, y = l.hasOwnProperty, v = p.trim, b = function(e, t) {
        ...
        o.addEventListener ? (o.removeEventListener("DOMContentLoaded", H, !1), e.removeEventListener("load", H, !1)) : (o.
detachEvent("onreadystatechange", H), e.detachEvent("onload", H));
    };
    b.fn = b.prototype = {
        jquery: p,
        constructor: b,
        ...
        slice: function() {
            return this
.pushStack(h.apply(this, arguments));
        },
        first: function() {
            return this.eq(0);
        },
...
e && b.isFunction(e.promise) ? e.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[a + "With"](this === r ? n.promise() : this, s ? [ e ] : arguments);
        ...
        when: function(e) {
            var t = 0, n = h.call(arguments), r = n.length, i = 1 !== r || e && b.
isFunction(e.promise) ? r : 0, o = 1 === i ? e : b.Deferred(), a = function(e, t, n) {
                return function(r) {
        ...
        s = o.createElement("select"), l = s.appendChild(o.createElement("option")), a = d.
getElementsByTagName("input")[0], r.style.cssText = "top:1px;float:left;opacity:.5", t = {
...
: !0,
        ...
        return d.style
.backgroundClip = "content-box", d.cloneNode(!0).style.backgroundClip = "", t.clearCloneStyle = "content-box" === d.style.backgroundClip, b(function() {
        ...
        if (b.acceptData(e)) {
            ...
            if (s[u]) {
                if (t && (o = n ? s[u] : s[u].data)) {
                    b.isArray(t) ? t = t.concat(b.map(t, b.camelCase)) : t in o ? t = [ t ] : (t = b.
camelCase(t), t = t in o ? [ t ] : t.split(" "));
...
_removeData: function(e, t) {
        ...
        data: function(e, n) {
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                return n === t ? 
o ? W(o, e, b.data(o, e)) : null : (this.each(function() {
                    b.data(this, e, n);
                }), t);
...
r && r.set(this, o, "value") !== t || (this.value = o));
        ...
        attr: function(e, n, r) {
            ...
            if (e && 3 !== u && 8 !== u && 2 !== u) return typeof e.getAttribute === i ? b.prop(e, n, r) : (a = 1 !== u || !b.isXMLDoc(e), a && (n = n.toLowerCase(), o = b.attrHooks[n] || (J.test(n) ? z : I)), r === t ? o && a && "get" in o && null !== (s = o.get(e, n)) ? s : (typeof e.getAttribute !== i && (s = e.getAttribute(n)), null == s ? t : s) : null !== r ? o && a && "set" in o && (s = o.set(e, r, n)) !== t ? s : (e.setAttribute
...
g = (a ? p.delegateType : p.bindType) || g, p = b.event.special[g] || {}, d = b.extend({
        ...
        trigger: function(n, r, i, a) {
            var s, u, l, c, 
p, f, d, h = [ i || o ], g = y.call(n, "type") ? n.type : n, m = y.call(n, "namespace") ? n.namespace.split(".") : [];
...
this) if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
        ...
        fix: function(e) {
            ...
            return e.target || (e.target = a.srcElement || o), 3 === e.target
.nodeType && (e.target = e.target.parentNode), e.metaKey = !!e.metaKey, s.filter ? s.filter(e, a) : e;
        },
        ...
        mouseHooks: {
            ...
            filter: function(e, n) {
                ...
                return null == e.pageX && null != n.clientX && (i = e.target.ownerDocument || o, a = i.documentElement, r = i.body, e.pageX = n.clientX + (a && a.scrollLeft || r && r.scrollLeft || 0) - (a && a.clientLeft || 
r && r.clientLeft || 0), e.pageY = n.clientY + (a && a.scrollTop || r && r.scrollTop || 0) - (a && a.clientTop || r && r.clientTop || 0)), !e.relatedTarget && u && (e.relatedTarget = u === e.target ? n.toElement : u), e.which || s === t || (e.which = 1 & s ? 1 : 2 & s ? 3 : 4 & s ? 2 : 0), e;
            }
        },
        special: {
            load: {
...
e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault() ? it : ot) : this.type = e, n && b.extend(this, n), this.timeStamp = e && e.timeStamp || b.now(), this[b.expando] = !0, t) : new b.Event(e, n);
    }, b.Event.prototype = {
...
,
        ...
        postDispatch: function(e) {
            e.
_submit_bubble && (delete e._submit_bubble, this.parentNode && !e.isTrigger && b.event.simulate("submit", this.parentNode, e, !0));
        },
        teardown: function() {
...
e.handleObj, b(e.delegateTarget).off(i.namespace ? i.origType + "." + i.namespace : i.origType, i.selector, i.handler), this;
            if ("object" == typeof e) {
        ...
        var n, r, i, o, a, s, u, l, c, p, f, d, h, g, m, y, v, x = "sizzle" + -(new Date), w = e.document, T = {}, N = 0, C = 0, k = it(), E = it(), S = it(), A = typeof t, j = 1 << 31, D = [], L = D.pop, H = D.push, q = D.slice, M = D.indexOf || function(e) {
            ...
            return -1;
        }, _ = "[\\x20\\t\\r\\n\\f]", F = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", O = F.replace("w", "w#"), B = "([*^$|!~]?=)", P = "\\[" + _ + "*(" + F + ")" + _ + "*(?:" + B + _ + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + O + ")|)|)" + _ + "*\\]", R = ":(" + F + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + P.replace(3, 8) + ")*)|.*)\\)|)", W = RegExp("^" + _ + "+|((?:^|[^\\\\])(?:\\\\.)*)" + _ + "+$", "g"), $ = RegExp("^" + _ + "*," + 
...
.getElementsByName(x).length === 2 + n.getElementsByName(x + 0).length;
...
return r;
                ...
                e.innerHTML = "<input type='hidden' i=''/>", e.querySelectorAll("[i^='']").length && h.push("[*^$]=" + _ + "*(?:\"\"|'')"), e.querySelectorAll(":enabled").length || h.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"
), h.push(",.*:");
...
e.compareDocumentPosition(t)) ? 1 & r || e.parentNode && 11 === e.parentNode.nodeType ? e === n || y(w, e) ? -1 : t === n || y(w, t) ? 1 : 0 : 4 & r ? -1 : 1 : e.compareDocumentPosition ? -1 : 1;
            ...
            if ((e.ownerDocument || 
e) !== p && c(e), t = t.replace(Z, "='$1']"), !(!T.matchesSelector || d || g && g.test(t) || h.test(t))) try {
                var n = m.call(e, t);
...
i.indexOf(n) > -1 : "$=" === t ? n && i.slice(-n.length) === n : "~=" === t ? (" " + i + " ").indexOf(n) > -1 : "|=" === t ? i === n || i.slice(0, n.length + 1) === n + "-" : !1) : !0;
                    };
                },
            ...
            if (!r && 1 === p.length) {
                ...
                while (o--) {
                    ...
                    if ((c = i.find[l]) && (r = c(u.matches[0].replace(et, tt), V.test(a[0].type) && t.parentNode || t))) {
                        if (a.splice(o
, 1), e = r.length && dt(a), !e) return H.apply(n, q.call(r, 0)), n;
                        break;
                    }
                }
            }
...
siblings: function(e) {
        ...
        dir: function(e, n, r) {
            var i = [], o = e[n];
            while (o && 9 !== o.nodeType && (r === t || 1 !== 
o.nodeType || !b(o).is(r))) 1 === o.nodeType && i.push(o), o = o[n];
            return i;
        },
    ...
    function dt(e) {
        ...
        if (n.
createElement) while (t.length) n.createElement(t.pop());
        return n;
    }
...
function(e) {
        ...
        remove: function(e, t) {
            var n, r = 0;
            for (; null != (n = this[r]); r++) (!e || b.filter(e, [ n ]).length > 0) && (t || 1 !== n.nodeType || b.cleanData(Ot(n)), n.parentNode && (
t && b.contains(n.ownerDocument, n) && Mt(Ot(n, "script")), n.parentNode.removeChild(n)));
        ...
        domManip: function(e, n, r) {
            e = f.apply([], e);
            var i, 
o, a, s, u, l, c = 0, p = this.length, d = this, h = p - 1, g = e[0], m = b.isFunction(g);
...
type: "GET",
    ...
    function _t(e, t) {
        if (1 === t.nodeType && b.hasData(e)) {
            var n, r, i, o = b._data(e), a = b._data(t, 
o), s = o.events;
            if (s) {
    ...
    function Ft(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === n && t.text !== e.text ? (Ht(t).text = e.text, qt(t)) : "object" === n ? (t.parentNode && (t.outerHTML = e.outerHTML), b.support.html5Clone && e.innerHTML && !b.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Nt.test(e.type) ? (t.defaultChecked = t.checked = e.checked, t.value !== e.value && (t.value = e.value)) : "option" === n ? t.defaultSelected = t.selected = 
...
, Vt = RegExp("^(" + x + ")(.*)$", "i"), Yt = RegExp("^(" + x + ")(?!px)[a-z%]+$", "i"), Jt = RegExp("^([+-])=(" + x + ")", "i"), Gt = {
        BODY: "block"
    }, Qt = {
        position: "absolute",
        visibility: "hidden",
    ...
    function rn(e, t) {
        ...
        for (; s > a; a++) r = e[a], r.style && (o[a] = b._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && 
nn(r) && (o[a] = b._data(r, "olddisplay", un(r.nodeName)))) : o[a] || (i = nn(r), (n && "none" !== n || !i) && b._data(r, "olddisplay", i ? n : b.css(r, "display"))));
...
e;
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (n = b.cssProps
[u] || (b.cssProps[u] = tn(l, u)), s = b.cssHooks[n] || b.cssHooks[u], r === t) return s && "get" in s && (o = s.get(e, !1, i)) !== t ? o : l[n];
...
(i = l.left, o = e.runtimeStyle, a = o && o.left, a && (o.left = e.currentStyle.left), l.left = "fontSize" === n ? "1em" : u, u = l.pixelLeft + "px", l.left = i, a && (o.left = a)), "" === u ? "auto" : u;
    });
    function on(e, t, n) {
        var r = Vt.exec(t);
    ...
    function sn(e, t, n) {
        var r = !0, i = "width" === t ? e.offsetWidth : e.offsetHeight, o = Rt(e), a = b.support.boxSizing && "border-box" === b.css(e, "boxSizing", !1, 
o);
        if (0 >= i || null == i) {
...
return r ? 0 === e.offsetWidth && Xt.test(b.css(e, "display")) ? b.swap(e, Qt, function() {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1, (t >= 1 || "" === t) && "" === b.trim(o.replace($t, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = 
    ...
    b.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !b(this).is(":disabled") && hn.test(this.nodeName) && !dn.test(e) && (this
.checked || !Nt.test(e));
            }).map(function(e, t) {
                var n = b(this).val();
...
, t, n, r) {
    ...
    var mn, yn, vn = b.now(), bn = /\?/, xn = /#.*$/, wn = /([?&])_=[^&]*/, Tn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Nn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Cn = /^(?:GET|HEAD)$/, kn = /^\/\//, En = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/
            ...
            var r, i, o, a, s, u, l, c, p = b.ajaxSetup({}, n), f = p.context || p, d = p.context && (f.nodeType || f.jquery) ? b(f) : b.event, h = b.Deferred(), g = b.Callbacks("once memory"), m = p.statusCode || {}, y = {}, v = {}, x = 0, T = "canceled", N = 
{
                ...
                statusCode: function(e) {
                    var t;
                    if (e) if (2 > x) for (t in 
e) m[t] = [ m[t], e[t] ]; else N.always(e[N.status]);
                    return this;
                },
                abort: function(e) {
                    var t = e || T;
...
(), p.hasContent = !Cn.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (bn.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = wn.test(o) ? o.replace(wn, "$1_=" + vn++) : o + (bn.test(o) ? "&" : "?") + "_=" + vn++)), p.ifModified && (b.lastModified[o] && N.setRequestHeader("If-Modified-Since", b.lastModified[o]), b.etag[o] && N.setRequestHeader("If-None-Match", b.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && N.setRequestHeader("Content-Type", p.contentType), N.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Dn + "; q=0.01" : "") : p.accepts["*"]);
...
complete: 1
                ...
                function k(e, n, r, i) {
                    var c, y, v, w, T, C = n;
                    2 !== x && (x = 2, s && clearTimeout(s), l = t, a = i || "", N.readyState = e > 0 ? 4 : 0, r && (w = _n(p, N, r)), e >= 200 && 300 > e || 304 === e ? (p.ifModified && (T = N.getResponseHeader("Last-Modified"), T && (b.lastModified[o] = T), T = N.getResponseHeader("etag"), T && (b.etag[o] = T)), 204 === e ? (c = !0, C = "nocontent") : 304 === 
e ? (c = !0, C = "notmodified") : (c = Fn(p, w), C = c.state, y = c.data, v = c.error, c = !v)) : (v = C, (e || !C) && (C = "error", 0 > e && (e = 0))), N.status = e, N.statusText = (n || C) + "", c ? h.resolveWith(f, [ y, C, N ]) : h.rejectWith(f, [ N, C, v ]), N.statusCode(m), m = t, u && d.trigger(c ? "ajaxSuccess" : "ajaxError", [ N, p, c ? y : v ]), g.fireWith(f, [ N, C ]), u && (d.trigger("ajaxComplete", [ N, p ]), --b.active || b.event.trigger("ajaxStop")));
                }
                return N;
            }
            return N.abort();
        ...
        "*": [ function(e, t) {
            ...
            if (o) {
                if (n = +o[2], r = o[3] || (b.cssNumber[e] ? "" : "px"), "px" !== r && s) {
                    ...
                    do u = u || ".5", s /= u, b.style(i.elem, e, s + r); while (u !== (u = 
i.cur() / a) && 1 !== u && --l);
                }
...
l), b.fx.timer(b.extend(u, {
    ...
    function nr(e, t, n) {
        var r
, i, o, a, s, u, l, c, p, f = this, d = e.style, h = {}, g = [], m = e.nodeType && nn(e);
        ...
        for (i in t) if (a = t[i], Vn.exec(a)) {
            if (delete t
[i], u = u || "toggle" === a, a === (m ? "hide" : "show")) continue;
            g.push(i);
        }
        if (o = g.length) {
...
this.start = this.now = this.cur(), this.end = r, this.unit = o || (b.cssNumber[n] ? "" : "px");
        },
        cur: function() {
        ...
        animate: function(e, t, n, r) {
            var i = b.isEmptyObject(e), o = b.speed(t
, n, r), a = function() {
...
(this, e, t);
        ...
        setOffset: function(e, t, n) {
            ...
            u ? (c = i.position(), p = c.top, f = c.left) : (p = parseFloat(a) || 0, f = parseFloat(s) || 0), b.isFunction(t) && (t = t.call(e, n, o)), null != t.top && (l.top = t.top - o
.top + p), null != t.left && (l.left = t.left - o.left + f), "using" in t ? t.using.call(e, l) : i.css(l);
        }
    }, b.fn.extend({
        position: function() {
            if (this[0]) {
...
})(window), define("text", [ "module" ], function(module) {
...
location.href, defaultProtocol = hasLocation && location.protocol && location.protocol.replace(/\:/, ""), defaultHostName = hasLocation && location.hostname, defaultPort = hasLocation && (location.port || undefined), buildMap = {}, masterConfig = module.config && module.config() || {};
    text = {
        version: "2.0.10",
...
.isBuild = config.isBuild;
            ...
            !hasLocation || useXhr(url, defaultProtocol, defaultHostName, defaultPort) ? text.get(url, function(content) {
        ...
        write: function(pluginName, moduleName, write, config) {
            if (buildMap.hasOwnProperty(moduleName)) {
                ...
                write
.asModule(pluginName + "!" + moduleName, "define(function () { return '" + content + "';});\n");
            }
        },
    ...
    if (masterConfig.env === "node" || !masterConfig.env && typeof process != "undefined" && process.versions && !!process.versions.node && !process.versions
["node-webkit"]) fs = require.nodeRequire("fs"), text.get = function(url, callback, errback) {
        try {
        ...
        masterConfig.onXhr && masterConfig.onXhr(xhr, url), xhr.onreadystatechange = function(evt) {
            var status, err;
            xhr.readyState === 4 && (status = xhr.status, status > 399 && status < 600 ? (err = new Error(url + " HTTP status: " + status), err.xhr = xhr, errback(err)) : callback(xhr.responseText), masterConfig
.onXhrComplete && masterConfig.onXhrComplete(xhr, url));
        }, xhr.send(null);
        ...
        try {
            inStream = Cc["@mozilla.org/network/file-input-stream;1"].createInstance(Ci.nsIFileInputStream), inStream.init(fileObj, 1, 0, !1), convertStream = Cc["@mozilla.org/intl/converter-input-stream;1"].createInstance(Ci.nsIConverterInputStream), convertStream.init(inStream, "utf-8", inStream.available(), Ci.nsIConverterInputStream.DEFAULT_REPLACEMENT_CHARACTER), convertStream.readString(inStream.available(), readData), convertStream.close(), inStream.close
(), callback(readData.value);
    ...
    var CACHE_BUST_QUERY_PARAM = "bust", CACHE_BUST_FLAG = "!bust", jsonParse = typeof JSON != "undefined" && typeof JSON.parse == "function" ? JSON.parse : function(val) {
        return eval("(" + val + ")");
    }, buildMap = {};
    function cacheBust(url) {
        return url = url.replace(CACHE_BUST_FLAG, ""), url += url.indexOf("?") < 0 ? "?" : "&", url + CACHE_BUST_QUERY_PARAM + "=" + Math.round(2147483647 * Math.random());
    }
    return {
        load: function(name, req, onLoad, config) {
            !config.isBuild || config.inlineJSON !== !1 && name.indexOf(CACHE_BUST_QUERY_PARAM + "=") === -1 ? text.get(req.toUrl(name), function(data) {
                config.isBuild ? (buildMap[name] = data, onLoad(data)) : onLoad(jsonParse(data));
            }, onLoad.error, {
...
accept: "application/json"
        ...
        normalize: function(name, normalize) {
            return name.indexOf(CACHE_BUST_FLAG) !== -1 && (name = cacheBust(name)), normalize(name);
        },
...
}), define("json!app/modules/routes.json", function() {
    return [ {
        name: "chairmanz-resort",
        slug: "bangalore-drink-deals/chairmans-jade-resort-devanahalli.html",
        method: "GET"
    }, {
        name: "woodstock-indira-nagar",
        slug: "bangalore-drink-deals/woodstok-indira-nagar.html",
        method: "GET"
    }, {
        name: "via-milano",
        slug: "bangalore-drink-deals/via-milano-italian-restaurant-lounge-koramangala.html",
        
method: "GET"
    }, {
        name: "barleyz",
        slug: "bangalore-drink-deals/barleyz-the-brew-house-koramangala.html",
        method: "GET"
    }, {
        name: "platter-banashankari",
        slug: "bangalore-drink-deals/the-platter-restaurant-lounge-banashankari.html",
        method: "GET"
    }, {
        name: "index",
        slug: "index.html",
        ...
        name: "careers/web-developer",
        slug: "careers/web-developer.html"
,
        method: "GET"
    }, {
        name: "careers/web-graphic-designer",
        slug: "careers/web-graphic-designer.html",
        method: "GET"
    }, {
        name: "careers/sales-manager",
        slug: "careers/sales-manager.html",
        method: "GET"
    }, {
        name: "careers/inside-sales",
        slug: "careers/inside-sales.html",
        method: "GET"
    }, {
        name: "peacock",
        slug: "bangalore-drink-deals/peacock-indira-nagar.html",
        method: "GET"
    }, {
        ...
        name: "doff-the-pub-n-lounge",
        slug: "bangalore-drink-deals/doff-the-pub-and-lounge-indira-nagar.html",
        method: "GET"
    }, {
        name: "lock-n-load-club",
        slug: "bangalore-drink-deals/lock-n-load-club-sahakara-nagar.html",
        method: "GET"
    } ];
}), define("app/common/lib/env", [], function(hostname) {
    return {
        baseUrl: "http://beta.app.vgulp.com"
,
        context: "vgulpjs"
    };
}), define("app/common/lib/Routes", [ "app/common/lib/env" ], function(env) {
...
function(a, b) {
        ...
        d: function(a, b, c, d) {
            ...
            for (var h = 1
; h < e.length; h++) f && typeof f == "object" && e[h] in f ? (g = f, f = f[e[h]]) : f = "";
...
if (a && t()) for (var c = p; c < m.length; c++) m[c].tag || m.splice(c, 1); else b || m.push({
                tag: "\n"
            });
            n = !1, p = m.length;
        }
...
;
    ...
    function p(a) {
        ...
        for (var c = 0, d = a.length; c < d; c++) {
            var e = a[c].tag;
            e == "#" ? b += q(a[c].nodes, a[c].n, o(a[c].n), a[c].i, a[c].end) : e == "^" ? b += r(a[c].nodes, a[c].n, o(a[c].n)) : e == "<" || e == ">" ? b += s(a[c].n) : e == "{" || 
...
typeof module != "undefined" && module.exports ? (module.exports = Hogan, module.exports.Template = HoganTemplate) : typeof exports != "undefined" && (exports.Hogan = Hogan, exports.HoganTemplate = HoganTemplate), define("hogan", function() {}), function() {
    function j(w) {
        throw w;
    }
    var m = !0, p = null, r = !1;
    ...
    var x = window, y = document, ga = navigator, F = 
window.jQuery, I = void 0;
    function L(w) {
...
function S(a, b, c, e, f) {
            var g = Math.min, h = Math.max, k = [], l, n = a.length, q, s = b.length, v = s - n || 1, G = n + s + 1, J, A, z;
            for (l = 0; l <= n; l++) {
                A = J, k.push(J = []), z = g(s, l + v);
...
for (b = c = 0; (f || b < a) && (t = h[c]); c++) {
        ...
        function T(a, d, c, e, f) {
            ...
            b.za.vb(c, h, g), c = h.renderTemplate(c, e, f, g), ("number" != typeof c.length || 0 < c.length && "number" != typeof c[0].nodeType) && j(Error("Template engine must return an array of DOM nodes")), g = r;
            switch (d) {
...
for (var s in k) {
        ...
        function Y(a, d, c) {
            ...
            f && b.e.Ta(d);
            if (f && c || b.J.instance.nodeHasBindings
(d)) e = X(d, p, a, c).Nb;
            e && Z(a, d, !f);
        }
        function Z(a, d, c) {
...
return b[c];
        ...
        function ba(a, b, c) {
            ...
            c = c || new la, a = b(a);
            if ("object" != typeof a || a === p || a === I || a instanceof 
Date) return a;
        ...
        function Q(a, d, c, e) {
            b.c[a] = {
                ...
                update: function(a, g, h, k, l) {
                    h = 
b.a.f.get(a, da), g = b.a.d(g()), k = !c != !g;
                    var n = !h.Za;
...
;
                ...
                P: function(a, b) {
                    if (b instanceof Array) a.push.apply(a, b); else for (var d = 0, c = b.length; d < c; d++) a.push(b[d]);
                    return a;
                },
                extend: function(a, b) {
...
a) {
                ...
                Jb: function(a, d, c) {
                    c = c || {};
                    var e = c.params || {}, f = c.includeFields || 
this.Na, g = a;
        ...
        }, b.b("utils", b.a), b.b("utils.arrayForEach", b.a.o), b.b("utils.arrayFirst", b.a.lb), b.b("utils.arrayFilter", b.a.fa), b.b("utils.arrayGetDistinctValues"
, b.a.Ga), b.b("utils.arrayIndexOf", b.a.i), b.b("utils.arrayMap", b.a.V), b.b("utils.arrayPushAll", b.a.P), b.b("utils.arrayRemoveItem", b.a.ga), b.b("utils.extend", b.a.extend), b.b("utils.fieldsIncludedWithJsonPost", b.a.Na), b.b("utils.getFormFields", b.a.Oa), b.b("utils.peekObservable", b.a.ua), b.b("utils.postJson", b.a.Jb), b.b("utils.parseJson", b.a.Ib), b.b("utils.registerEventHandler", b.a.n), b.b("utils.stringifyJson", b.a.xa), b.b("utils.range", b.a.Lb), b.b("utils.toggleDomNodeCssClass", b.a.da), b.b("utils.triggerEvent", b.a.Ba), b.b("utils.unwrapObservable", b.a.d), Function.prototype.bind || (Function.prototype.bind = function(a) {
...
get: function(a, d) {
            ...
            function d(c) {
                ...
                b.a.f.clear(c), "function" == typeof F && "function" == typeof F.cleanData && F.cleanData([ c ]);
...
if (e[a.nodeType] && (d(a), f[a.nodeType])) {
            ...
            var d;
            if ("undefined" != typeof F) {
                if (F.parseHTML) d = F.parseHTML(a); else if ((d = F.clean([ a ])) && d[0]) {
...
a.parentNode && a.parentNode.removeChild(a);
                ...
                d = y.createElement("div"), c = c.match(/^<(thead|tbody|tfoot)/) && [ 1, "<table>", "</table>" ] || !c.indexOf("<tr") && [ 2, "<table><tbody>", "</tbody></table>" ] || (!c.indexOf("<td") || !c.indexOf("<th")) && [ 3, "<table><tbody><tr>", "</tr></tbody></table>" ] || [ 0, "", "" ], a = "ignored<div>" + c[1] + a + c[2] + "</div>";
            ...
            b.a.ka(a), d = b.a.d(d);
            if (d !== p && d !== I) if ("string" != typeof d && (d = d.toString()), "undefined" != typeof F) F(a).html(d); else for (var c = b.a.ta(d), e = 0; e < c.length; e++) a.appendChild(c[e]);
        }, b.b("utils.parseHtmlFragment"
, b.a.ta), b.b("utils.setHtml", b.a.ca);
        var R = {};
        b.s = {
            ra: function(a) {
...
d.notifySubscribers(c);
        ...
        b.m.fn[E] = b.m, b.ma = function(a, d) {
            ...
            0 == arguments.length && (a = []), a !== p && a !== I && !("length" in a) && j(Error
...
var v = c.write, G = c.disposeWhenNodeIsRemoved || c.W || p, w = c.disposeWhen || c.Ka || u(r), A = e, z = [], t = p;
            d || (d = c.owner), h.t = function() {
                return n || g(), l;
            }, h.xb = function() {
                return z.length;
            }, h.zb = "function" == typeof c.write, h.B = function() {
                A();
            }, h.pa = k, b.S.call(h), b.a.extend(h, b.j.fn), b.p(h, "peek", h.t), b.p(h, "dispose", h.B), b.p(h, "isActive", h.pa), b.p(h, "getDependenciesCount", h.xb), c.deferEvaluation !== m && g();
            if (G && k()) {
                A = function() {
            ...
            return b.ma(a, b.j);
        }, w = b.m.Kb, b.j[w] = b.m, b.j.fn = {}, b.j.fn[w] = b.j, b.b("dependentObservable"
, b.j), b.b("computed", b.j), b.b("isComputed", b.Bb), b.gb = function(a) {
...
switch (b.a.u(a)) {
        ...
        }, b.b("selectExtensions", b.k), b.b("selectExtensions.readValue"
, b.k.q), b.b("selectExtensions.writeValue", b.k.T);
...
value: P(g, a)
            ...
            ba: function(a) {
                ...
                for (var e, f = 0; e = d[f]; f++) if (0 < c.length && c.push(","), e.key) {
                    ...
                    e = e.value, c.push(g), c.push(":"), c.push(e), e = b.a.D(e), 0 <= b.a.i(na, b.a.D(e).toLowerCase()) ? e = r : (h = e.match(oa), e = h === p ? r : h[1] ? "Object(" + h[1] + ")" + h[2] : e), e && 
(0 < a.length && a.push(", "), a.push(g + " : function(__ko_value) { " + e + " = __ko_value; }"));
            ...
            ea: function(a, d, c, e, f) {
                !a || !b.Ra(a) ? (a = d()._ko_property_writers) && a[c] && a[c](e) : (!f || a.t() !== e) && a(e);
            }
        ...
        var K = "<!--test-->" === y.createComment("test"
).text, ja = K ? /^\x3c!--\s*ko(?:\s+(.+\s*\:[\s\S]*))?\s*--\x3e$/ : /^\s*ko(?:\s+(.+\s*\:[\s\S]*))?\s*$/, ia = K ? /^\x3c!--\s*\/ko\s*--\x3e$/ : /^\s*\/ko\s*$/, pa = {
            ul: m,
            ol: m
        };
        b.e = {
            ...
            Va: function(a, b) {
                B(a) ? a.parentNode.insertBefore(b, a.nextSibling) : a.firstChild ? a.insertBefore(b, a.firstChild) : a.appendChild
(b);
            },
            Pa: function(a, d, c) {
            ...
            Ta: function(a) {
                if (pa[b.a.u(a)]) {
                    ...
                    if (d) do if (1 === d.nodeType) {
                        ...
                        c = d.firstChild;
                        var e = p;
                        if (c) do if (e) e.push(c); else if (B(c)) {
                            var f = $
(c, m);
                            f ? c = f : e = [ c ];
                        } else H(c) && (e = [ c ]); while (c = c.nextSibling);
                        if (c = e) {
                            e = d.nextSibling;
...
.e.jb(a) != p;
            ...
            if (2 != arguments.length) return b.a.f.get(a, "__ko_bindingContext__");
            b.a.f.set(a, "__ko_bindingContext__", d);
        }, b.Fa = function(a, d, c) {
            return 1 === a.nodeType && b.e.Ta(a
), X(a, d, c, m);
        }, b.Ea = function(a, b) {
...
b.c.attr = {
            ...
            init: function(a, d, c) {
                b.a.n(a, "click", function() {
                    var e;
                    if ("checkbox" == a.type) e = a.checked; else {
                        if ("radio" != a.type || !a.checked) return;
                        e = a.value;
                    }
                    var f = d(), g = b.a.d(f);
                    "checkbox" == a.type && g instanceof Array ? (e = b.a.i(g, a.value), a.checked && 0 > e ? f.push(a.value) : !a.checked && 0 <= e && 
f.splice(e, 1)) : b.g.ea(f, c, "checked", e, m);
...
if (c.optionsCaption) {
                    ...
                    h = a.getElementsByTagName("option"), d = k = 0;
...
c, d);
            ...
            a = this.makeTemplateSource(a, c), b = b(a.text()), a.text(b), a
.data("isRewritten", m);
        ...
        b.wa = function(a) {
            ...
            c = c || {}, (c.templateEngine || O) == I && j(Error("Set a template engine before calling renderTemplate")), f = f || "replaceChildren";
            if (e) {
                var g = N(e);
                return b.j(function() {
            ...
            update: function(a, d, c, e, f) {
                d = b.a.d(d()), c = {}, e = m;
                var g, h = p;
                "string" != typeof d && (c = d, d = c.name, "if" in c && (e = b.a.d(c["if"])), e && "ifnot" in c && (e = !b.a.d(c.ifnot)), g = b.a.d(c.data)), "foreach" in c ? h = b.Mb(d || a, e && c.foreach || [], c, a, f) : e ? (f = "data" in c ? f.createChildContext(g, c.as) : f, h = b.va(d || a, f, c, a)) : b.e.Y(a), f = h, (g = b.a.f.get(a, "__ko__templateComputedDomDataKey__")) && "function" == typeof 
g.B && g.B(), b.a.f.set(a, "__ko__templateComputedDomDataKey__", f && f.pa() ? f : I);
            }
...
;
            ...
            this.renderTemplateSource = function(b, c, e) {
                ...
                y.write("<script type='text/html' id='" + 
a + "'>" + b + "</script>");
...
: !1,
    version: "0.1.0"
}), ko.setTemplateEngine(new ko.hoganTemplateEngine), define("hoganTemplateEngine", [ "hogan", "knockout" ], function() {}), define("text!app/request-invite/views/requestInviteWithGo.html", [], function() {
    return '<input class="span5" data-bind="value:email"> <button class="btn btn-primary" data-bind="click:ask">GO</button>\n<div id="preferredLocationsModal" class="modal hide fade" data-bind="showModal:show">\n    <form data-bind="submit:updateInvite">\n\n        <div class="modal-header">\n            <button type="button" class="close" data-bind="click:openShareThis">&times;</button>\n            <h3>Your preferred locations for deals</h3>\n        </div>\n        <div class="modal-body">\n            <input name="preferredLocations" class="input-block-level" placeholder="Preferred Location" data-bind="tagsInput:preferredLocationsQuery">\n            <div class="alert alert-block alert-success fade in margin-top-20" data-bind="visible:success">\n                <button type="button" class="close" data-dismiss="alert">&times;</button>\n                <h4 class="alert-heading text-center">Super!</h4>\n                <p class="text-center">You are what we had in mind when we started this. Check your deal in your mailbox!</p>\n            </div>\n            <div class="alert alert-block alert-error fade in margin-top-20" data-bind="visible:failure">\n                <button type="button" class="close" data-dismiss="alert">&times;</button>\n                <h4 class="alert-heading text-center">Oh shucks! You got an error!</h4>\n                <p class="text-center">We don&apos;t really know what the heck happened for now. Please try again.</p>\n            </div>\n        </div>\n        <div class="modal-footer">\n            <button type="submit" href="#" class="btn btn-primary btn-medium text-center">Submit And Continue</button>\n            <button  href="#" class="btn btn-warning btn-medium" data-bind="click:openShareThis">Skip</button>\n        </div>\n    </form>\n\n</div>\n<div id="shareSocial" class="modal hide fade text-center" data-bind="showModal:showShareThis">\n    <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n        <h3><strong>Be the first to share it with friends</strong></h3>\n    </div>\n    <div class="modal-body">\n        <span class=\'st_facebook_hcount\' displayText=\'Facebook\'></span>\n        <span class=\'st_twitter_hcount\' displayText=\'Tweet\'></span>\n        <span class=\'st_email_hcount\' displayText=\'Email\'></span>\n    </div>\n\n</div>'
;
}), define("text!app/plain-html-modules/views/pressspeak.html", [], function() {
    return '<ul class="thumbnails">\n    <li class="span4">\n        <a href="http://www.nextbigwhat.com/startup-walks-into-a-bar-vgulp-297/"  class="thumbnail">\n            <h3>NextBigWhat</h3>\n            <p>Bacchanalian Bangaloreans don\u2019t really need a reason to drink, but in case you are looking for one, it is here.</p>\n        </a>\n    </li>\n    <li class="span4">\n        <a href="http://yourstory.in/2013/08/identifying-discounts-and-offers-on-alcoholic-beverages-nearby-with-vgulp/" class="thumbnail">\n            <h3>YourStory</h3>\n            <p>Next time when you are planning booze with friends in Bangalore \u2013 don\u2019t forget to check Vgulp\n            </p>\n        </a>\n    </li>\n    <li class="span4">\n        <a href="http://www.siliconindia.com/news/startups/Raise-A-Toast-To-Vgulp-A-Startup-That-Offers-Awesome-Drink-Deals-nid-152015-cid-100.html" class="thumbnail">\n            <h3>SiliconIndia</h3>\n            <p>Helping party-heads, light/ moderate and hardcore drinkers by providing negotiated deals, unbelievable offers and discounts.SiliconIndia</span></p>\n        </a>\n    </li>\n</ul>\n<ul class="thumbnails">\n    <li class="span4">\n        <a href="http://thetechpanda.com/vgulp-grab-a-deal-on-your-next-drink/" class="thumbnail">\n            <h3>TheTechPanda</h3>\n            <p>With hundreds of deals sites running for every conceivable stuff in the market, would anyone think that we would get deals for Drinkers? Enter Vgulp</p>\n        </a>\n    </li>\n    <li class="span4">\n        <a href="http://startupcentral.in/2013/07/love-your-sundowner-drink-smarter-with-vgulp-15888/" class="thumbnail">\n            <h3>StartupCentral</h3>\n            <p>This one is for serious tipplers. An online platform that aims to enable you to make smarter drinking choices</p>\n        </a>\n    </li>\n    <li class="span4">\n        <a href="http://www.iamwire.com/2013/08/vglup-helping-drinkers-find-deal-alcoholic-beverages/" class="thumbnail">\n            <h3>iamwire</h3>\n            <p>A niche online portal \u2018Vgulp\u2019 to help people make smart drinking choices.</p>\n        </a>\n    </li>\n</ul>\n<ul class="thumbnails">\n    <li class="span4">\n        <a href="http://www.deccanchronicle.com/130905/lifestyle-offbeat/article/tanked-tipple" class="thumbnail">\n            <h3>Deccan Chronicle</h3>\n            <p>The two Malayalies look determined to revolutionise the way Bengalureans drinks.</p>\n        </a>\n    </li>\n\n</ul>\n\n'
;
}), define("text!app/request-invite/views/requestInviteWhiteRow.html", [], function() {
    return '<div class="row-fluid margin-top-20">\n    <div class="span12">\n        <input class="span5" data-bind="value:email"> <button class="btn btn-primary btn-large" data-bind="click:ask">Request Invite</button>\n    </div>\n</div>\n<div id="preferredLocationsModal" class="modal hide fade" data-bind="showModal:show">\n    <form data-bind="submit:updateInvite">\n\n        <div class="modal-header">\n            <button type="button" class="close" data-bind="click:openShareThis">&times;</button>\n            <h3>Your preferred locations for deals</h3>\n        </div>\n        <div class="modal-body">\n            <input name="preferredLocations" class="input-block-level" placeholder="Preferred Location" data-bind="tagsInput:preferredLocationsQuery">\n            <div class="alert alert-block alert-success fade in margin-top-20" data-bind="visible:success">\n                <button type="button" class="close" data-dismiss="alert">&times;</button>\n                <h4 class="alert-heading text-center">Super!</h4>\n                <p class="text-center">You are what we had in mind when we started this. Check your deal in your mailbox!</p>\n            </div>\n            <div class="alert alert-block alert-error fade in margin-top-20" data-bind="visible:failure">\n                <button type="button" class="close" data-dismiss="alert">&times;</button>\n                <h4 class="alert-heading text-center">Oh shucks! You got an error!</h4>\n                <p class="text-center">We don&apos;t really know what the heck happened for now. Please try again.</p>\n            </div>\n        </div>\n        <div class="modal-footer">\n            <button type="submit" href="#" class="btn btn-primary btn-medium text-center">Submit And Continue</button>\n            <button  href="#" class="btn btn-warning btn-medium" data-bind="click:openShareThis">Skip</button>\n        </div>\n    </form>\n\n</div>\n<div id="shareSocial" class="modal hide fade text-center" data-bind="showModal:showShareThis">\n    <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n        <h3><strong>Be the first to share it with friends</strong></h3>\n    </div>\n    <div class="modal-body">\n        <span class=\'st_facebook_hcount\' displayText=\'Facebook\'></span>\n        <span class=\'st_twitter_hcount\' displayText=\'Tweet\'></span>\n        <span class=\'st_email_hcount\' displayText=\'Email\'></span>\n    </div>\n\n</div>'
;
}), define("text!app/plain-html-modules/views/randomContentLayout.html", [], function() {
    return '<div id="body" class="white-section">\n    <!-- ko template:{name:slugTemplate}-->  <!-- /ko -->\n    <!-- ko template:{name:layout.footer}-->  <!-- /ko -->\n    <!-- ko template:{name:ageGateTemplate,data:ageGateVM} --> <!-- /ko -->\n</div>';
}), define("text!app/request-invite/views/requestInvite.html", [], function() {
    return '<div class="row-fluid margin-top-20" data-bind="visible:showTopBar">\n    <div class="span12">\n        <div class="alert warning text-center">\n            <button type="button" class="close" data-bind="click:hideTopBar">&times;</button>\n                            <span class="lead">You needn\'t be a user to try any of these deals out.<br/>\n                            To get exclusive access to all our deals, please request invite here.<br/></span><br/>\n            <input class="span5" data-bind="value:email"> <button class="btn btn-primary" data-bind="click:ask">Request Invite</button>\n        </div>\n    </div>\n</div>\n<div id="preferredLocationsModal" class="modal hide fade" data-bind="showModal:show">\n    <form data-bind="submit:updateInvite">\n\n        <div class="modal-header">\n            <button type="button" class="close" data-bind="click:openShareThis">&times;</button>\n            <h3>Your preferred locations for deals</h3>\n        </div>\n        <div class="modal-body">\n            <input name="preferredLocations" class="input-block-level" placeholder="Preferred Location" data-bind="tagsInput:preferredLocationsQuery">\n            <div class="alert alert-block alert-success fade in margin-top-20" data-bind="visible:success">\n                <button type="button" class="close" data-dismiss="alert">&times;</button>\n                <h4 class="alert-heading text-center">Super!</h4>\n                <p class="text-center">You are what we had in mind when we started this. Check your deal in your mailbox!</p>\n            </div>\n            <div class="alert alert-block alert-error fade in margin-top-20" data-bind="visible:failure">\n                <button type="button" class="close" data-dismiss="alert">&times;</button>\n                <h4 class="alert-heading text-center">Oh shucks! You got an error!</h4>\n                <p class="text-center">We don&apos;t really know what the heck happened for now. Please try again.</p>\n            </div>\n        </div>\n        <div class="modal-footer">\n            <button type="submit" href="#" class="btn btn-primary btn-medium text-center">Submit And Continue</button>\n            <button  href="#" class="btn btn-warning btn-medium" data-bind="click:openShareThis">Skip</button>\n        </div>\n    </form>\n\n</div>\n<div id="shareSocial" class="modal hide fade text-center" data-bind="showModal:showShareThis">\n    <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n        <h3><strong>Be the first to share it with friends</strong></h3>\n    </div>\n    <div class="modal-body">\n        <span class=\'st_facebook_hcount\' displayText=\'Facebook\'></span>\n        <span class=\'st_twitter_hcount\' displayText=\'Tweet\'></span>\n        <span class=\'st_email_hcount\' displayText=\'Email\'></span>\n    </div>\n\n</div>'
;
}), define("text!app/age-gate/views/ageGate.html", [], function() {
    return '<div id="ageGate" class="modal hide fade text-center" data-bind="showModal:showAgeGate">\n    <div class="modal-header">\n        <h3><strong>Age Restricted Area</strong></h3>\n    </div>\n    <div class="modal-body">\n        <h5 class="margin-top-10">We are glad you are here</h5>\n        <h5>We need to verify if you are above the legal age for drinking</h5>\n\n        <h3>PLEASE CONFIRM YOUR AGE</h3>\n        <a href="#" class="btn btn-primary btn-large btn-block" data-bind="click:confirmLegalAge">I am of LEGAL DRINKING AGE in my REGION</a>\n        <p>Use of this site is for personal use in countries and territories where the consumption of alcoholic beverages is lawful.<br/>\n            Vgulp should be used by persons who are lawfully permitted to purchase and consume alcoholic beverages. <br/>\n            By entering this site, you agree to our terms and conditions.</p>\n    </div>\n\n</div>';
}), 
define("text!app/common/views/metaDetails.html", [], function() {
    return '<title data-bind="text:meta.title"></title>\n<meta name="description" data-bind="attr:{content:meta.description}">\n<meta property="og:title" data-bind="attr:{content:facebook.title}"  />\n<meta property="og:description"  data-bind="attr:{content:facebook.description}" />\n<meta property="og:url" data-bind="attr:{content:facebook.pageUrl}"/>\n<meta property="og:image" data-bind="attr:{content:facebook.imageUrl}"/>\n<meta itemprop="image" data-bind="attr:{content:facebook.pageUrl}"/>\n';
}), define("text!app/common/views/header.html", [], function() {
    return '<div id="header" class="navbar">\n    <div class="navbar-inner">\n        <div class="container">\n            <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-responsive-collapse">\n                <span class="icon-bar"></span>\n                <span class="icon-bar"></span>\n                <span class="icon-bar"></span>\n            </a>\n            <div class="logo-vgulp">\n                <a class="brand" href="/index.html"><img src="/img/vgulp-logo.jpg" alt="Vgulp Home"></a>\n            </div>\n            <div class="nav-collapse collapse navbar-responsive-collapse">\n\n                <ul class="nav pull-right">\n                    <li><a href="/deal-showcase.html"><button class="btn btn-warning btn-medium" >View all deals</button></a></li>\n                    <li><a class="page-links" href="/about.html">About</a></li>\n                    <li><a class="page-links" href="http://blog.vgulp.com">Blog</a></li>\n                    <li><a class="page-links" href="/business.html">Business</a></li>\n                    <li><a class="page-links" href="/careers.html">Work with us</a></li>\n                    <li><a class="page-links" href="/contact.html">Contact</a></li>\n                    <li class="divider-vertical"></li>\n                    <li><button onclick=\'javascript:window.location.href="http://beta.app.vgulp.com/oauth/facebook/authenticate"\' class="btn signup-small">Login</button></li>\n                </ul>\n            </div><!-- /.nav-collapse -->\n        </div>\n    </div><!-- /navbar-inner -->\n</div>       <!-- Navbar end-->'
;
}), define("text!app/common/views/footer.html", [], function() {
    return '<div id="footer" class="row-fluid white-section margin-top-20">\n    <div class="span12">\n        <ul>\n            <li><a class="page-links" href="/about.html">About</a></li>\n            <li><a class="page-links" href="http://blog.vgulp.com">Blog</a></li>\n            <li><a class="page-links" href="/business.html">Business</a></li>\n            <li><a class="page-links" href="/careers.html">Work with us</a></li>\n            <li><a class="page-links" href="/contact.html">Contact</a></li>\n            <li class="divider-vertical"></li>\n        </ul>\n        <ul class="nav pull-right">\n            <li><a>&copy;Vgulp 2013</a></li>\n            <li class="divider-vertical"></li>\n            <li>&nbsp;</li>\n            <li>&nbsp;</li>\n\n        </ul>\n    </div>\n</div>  <!--footer end-->';
}), !function($) {
    ...
    Dropdown.prototype = {
        ...
        toggle: function(e) {
            ...
            return $parent = getParent($this), isActive = $parent.hasClass("open"), clearMenus(), isActive || ("ontouchstart" in document.documentElement && $('<div class="dropdown-backdrop"/>').insertBefore($(this)).on("click", clearMenus), $parent.toggleClass("open")), $this.focus(), !1;
        },
        keydown: function(e) {
            var $this, $items, $active, $parent, isActive, index;
            if (!/(38|40|27)/.test(e.keyCode)) return;
            $this = $(this), e.preventDefault(), e.stopPropagation();
            if ($this.is(".disabled, :disabled")) return;
            $parent = getParent($this), isActive = 
$parent.hasClass("open");
            if (!isActive || isActive && e.keyCode == 27) return e.which == 27 && $parent.find(toggle).focus(), $this.click();
            $items = $("[role=menu] li:not(.divider):visible a", $parent);
            if (!$items.length) return;
            index = $items.index($items.filter(":focus")), e.keyCode == 38 && index > 0 && index--, e.keyCode == 40 && index < $items.length - 1 && index++, ~index || (index = 0), $items.eq(index).focus();
        }
    };
    function clearMenus() {
    ...
    function getParent($this) {
        ...
        selector || (selector = $this.attr("href"), selector = selector && /#/.test(selector) && selector.replace(/.*(?=#[^\s]*$)/, "")), $parent = selector && $(selector);
...
;
    ...
    $.fn.dropdown = function(option) {
        return this.each(function() {
            ...
            data || $this.data("dropdown", data = new Dropdown(this)), typeof option == "string" && data[option].call($this);
        });
...
}(window.jQuery), define("app/common/lib/bootstrap-dropdown", function() {}), define("app/common/vms/layout", [ "text!app/common/views/metaDetails.html", "text!app/common/views/header.html", "text!app/common/views/footer.html", "app/common/lib/bootstrap-dropdown" 
], function(metaDetails, header, footer, bootstrap) {
    var Layout = function() {
        var self = this;
    ...
    typeof define == "function" && define.amd ? define("jquery.cookie", [ "jquery" ], factory) : factory(jQuery);
}(function($) {
    var pluses = /\+/g;
    function decode(s) {
...
undefined) {
            ...
            var something = document.cookie = [ config.raw ? key : encodeURIComponent(key), "=", config.raw ? value : encodeURIComponent(value), options.expires ? "; expires=" + options.expires.toUTCString() : "", options.path ? "; path=" + options.path : "", options.domain ? "; domain=" + options.domain : "", options.secure ? "; secure" : "" ].join("");
        ...
        for (var i = 0, l = cookies.length; i < l; i++) {
            var parts = cookies[i
].split("="), name = decode(parts.shift()), cookie = parts.join("=");
            if (key && key === name) {
    ...
    config.defaults = {}, $.removeCookie = function(key, options) {
        return $.cookie(key) !== undefined ? ($.cookie(key, "", $.extend({}, options, {
            expires: -1
        })), !0) : !1;
    };
}), !function($) {
...
$(document).off("focusin.modal"), this.$element.removeClass("in").attr("aria-hidden", !0), $.support.transition && this.$element.hasClass("fade") ? this.hideWithTransition() : this.hideModal();
        },
...
.transition.end, function() {
        ...
        backdrop: function(callback) {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                this.$backdrop = $('<div class="modal-backdrop ' + animate + '" />').appendTo(document.body), this.$backdrop.click(this.options.backdrop == "static" ? $.proxy(this.$element[0].focus, this.$element[0]) : $.proxy(this.hide, this)), doAnimate && this.$backdrop[0].offsetWidth, this
...
}(window.jQuery), define("app/age-gate/lib/bootstrap-modal", function() {}), define("app/age-gate/lib/ageGate.ko.bindings", [ "app/age-gate/lib/bootstrap-modal" ], function() {
...
showModal
...
}), define("app/age-gate/vms/ageGate", [ "jquery", "jquery.cookie", "app/age-gate/lib/ageGate.ko.bindings" ], function($, cookie) {
    var AgeGate = function(data) {
        ...
        }, console.log("age Gate", data.showAgeGate), (data.showAgeGate === "false" || 
data.showAgeGate === !1) && self.showAgeGate(!1);
    };
    return AgeGate;
}), function($) {
    var defaults = {
        ...
        pushTag: function(tag, ignoreEvents) {
            ...
            tag = privateMethods
.trimTag(tag, opts.delimiterChars);
...
backgroundColor: opts.blinkBGColor_1
                ...
                tag: tag
            }, opts.AjaxPushParameters)), newTagId = $self.data("tm_rndid") + "_" + tagId, newTagRemoveId = $self.data("tm_rndid") + "_Remover_" + tagId, escaped = $("<span/>").text(tag).html(), html = '<span class="' + privateMethods.tagClasses.call($self) + '" id="' + newTagId + '">', html += "<span>" + escaped + "</span>", html += '<a href="#" class="tm-tag-remove" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">', html += opts.tagCloseIcon + "</a></span> ", $el = $(html), opts.tagsContainer !== null ? $(opts.tagsContainer).append
($el) : tagId > 1 ? (lastTagId = tagId - 1, lastTagObj = $("#" + $self.data("tm_rndid") + "_" + lastTagId), lastTagObj.after($el)) : $self.before($el), $el.find("#" + newTagRemoveId).on("click", $self, function(e) {
                e.preventDefault();
        ...
        popTag: function() {
            ...
            tlid.length > 0 && (tagId = tlid.pop(), tagBeingRemoved = tlis[tlis.length - 1], $self.trigger("tm:popping", tagBeingRemoved), tlis.pop(), $("#" + $self.data("tm_rndid") + "_" + tagId).remove(), privateMethods.refreshHiddenTagList.call($self), $self.trigger("tm:popped"
, tagBeingRemoved));
        },
        empty: function() {
        ...
        tagClasses: function() {
            ...
            return cl = tagBaseClass, $self.attr("class") && 
$.each($self.attr("class").split(" "), function(index, value) {
                value.indexOf(inputBaseClass + "-") !== -1 && (cl += " " + tagBaseClass + value.substring(inputBaseClass.length));
...
();
        ...
        spliceTag: function(tagId) {
            ...
            -1 !== idx && 
(tagBeingRemoved = tlis[idx], $self.trigger("tm:splicing", tagBeingRemoved), $("#" + $self.data("tm_rndid") + "_" + tagId).remove(), tlis.splice(idx, 1), tlid.splice(idx, 1), privateMethods.refreshHiddenTagList.call($self), $self.trigger("tm:spliced", tagBeingRemoved)), privateMethods.showOrHide.call($self);
        },
        init: function(options) {
            ...
            }), opts.baseDelimiter = String.fromCharCode(opts.delimiterChars[0] || 44), opts.tagBaseClass = "tm-tag", opts.inputBaseClass = "tm-input", 
$.isFunction(opts.validator) || (opts.validator = null), this.each(function() {
                ...
                }), $self.after(hiddenObj), $self.data("lhiddenTagList", hiddenObj)) : $self.data("lhiddenTagList", $(opts.output)), opts.AjaxPushAllTags && ($self.on("tm:spliced", privateMethods.pushAllTags), $self.on("tm:popped", privateMethods.pushAllTags), $self.on("tm:pushed", privateMethods.pushAllTags)), $self.on("focus keypress"
, function(e) {
...
.userAgent.toLowerCase()) || $self.focus(), privateMethods.killEvent(e);
                });
    ...
    $.fn.tagsManager = function(method) {
        var $self = $(this);
        return 0 in this ? publicMethods[method] ? publicMethods[method].apply($self, Array.prototype.slice.call(arguments, 1)) : typeof method == "object" || !method ? privateMethods.init.apply(this, arguments
) : ($.error("Method " + method + " does not exist."), !1) : this;
    };
}(jQuery), define("app/request-invite/lib/tagmanager", function() {}), !function($) {
...
function(i, item) {
        ...
        listen: function() {
            this.$element.on("focus", $.proxy(this.focus, this)).on("blur", $.proxy(this.blur, this)).on("keypress", $.proxy(this.keypress, this)).on("keyup", $.proxy(this.keyup, this)), this.eventSupported("keydown") && this.$element.on("keydown", $.proxy(this.keydown, this)), 
...
}), define("app/request-invite/vms/requestInvite", [ "jquery", "knockout", "app/request-invite/lib/requestInvite.ko.bindings" ], function($, knockout) {
...
}), define("app/deal/vms/baseDealVM", [ "text!app/request-invite/views/requestInvite.html", "text!app/age-gate/views/ageGate.html", "app/common/vms/layout", "hogan", "app/age-gate/vms/ageGate", "app/request-invite/vms/requestInvite", "require" ], function(requestInvite, ageGate, layout, hogan, AgeGateVM, RequestInviteVM, require) {
    var BaseDealVM = function(content) {
        var self = this;
        console.log("AgeGATE", AgeGateVM), self.content = content, self.layout = layout, self.rendered = 
ko.observable(!1), self.ageGateVM = new AgeGateVM(content), self.requestInviteVM = new RequestInviteVM(content.env), self.ageGateTemplate = function() {
...
this.interval && clearInterval(this.interval), this.options.interval && !this.paused && (this.interval = setInterval($.proxy(this.next, this), this.options.interval)), this;
        },
        ...
        pause: function(e) {
            return e || (this.paused = !0), this.$element.find(".next, .prev").length && $.support.transition.end && (this.$element.trigger($.support.transition.end), this.cycle(!0)), 
...
var $nextIndicator = $(that.$indicators.children()[that.getActiveIndex()]);
            ...
            if ($.support.transition && this.$element.hasClass("slide")) {
                ...
                this.$element.trigger(e);
                if (e.isDefaultPrevented()) return;
                $active.removeClass("active"), $next.addClass("active"), this.sliding = !1, 
this.$element.trigger("slid");
    ...
    $.fn.carousel = function(option) {
        return this.each(function() {
            ...
            data || $this.data("carousel", data = new Carousel(this, options)), typeof option == "number" ? data.to(option) : action ? data[action]() : options.interval && data.pause().cycle();
        });
...
) || (href = $this.attr("href")) && href.replace(/.*(?=#[^\s]+$)/, "")), options = $.extend({}, $target.data(), $this.data()), slideIndex;
    ...
    return PlainContentVM.prototype = 
Object.create(BaseDealVM.prototype), PlainContentVM;
}), require.config({
    baseUrl: "js/lib",
    shim: {
    ...
    paths: {
        ...
        "plain-html-module"
: "../app/plain-html-modules/lib"
    }
}), define("../app/plain-html-modules/main", [ "jquery", "json!app/modules/routes.json", "app/common/lib/Routes", "hoganTemplateEngine", "app/plain-html-modules/vms/PlainContentVM", "app/common/lib/env", "require" ], function($, routes, Routes, hogan, PlainContentVM, env, require) {
...
}), require([ "../app/plain-html-modules/main" ]);;