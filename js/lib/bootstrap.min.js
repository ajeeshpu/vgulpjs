...
: "show"]();
        ...
        hide: function(b) {
            ...
            this.isShown = !1, this
.escape(), a(document).off("focusin.modal"), this.$element.removeClass("in").attr("aria-hidden", !0), a.support.transition && this.$element.hasClass("fade") ? this.hideWithTransition() : this.hideModal();
        },
        ...
        backdrop: function(b) {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                if (!b) return;
                e ? this.$backdrop
.one(a.support.transition.end, b) : b();
...
return this.each(function() {
    ...
    function b(b, c) {
        ...
        this.options = a.extend({}, a.fn.scrollspy.defaults, c), this.$scrollElement = e.on("scroll.scroll-spy.data-api", d), this.selector = (this.options.target || (f = a(b).attr("href")) && f.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a", this.$body = a("body"), 
...
b) {
    ...
    b.prototype = {
        ...
        leave: function(b) {
            ...
            this.timeout && clearTimeout(this
.timeout);
...
height: b.offsetHeight
        ...
        toggle: function(b) {
            var c = b ? a(b.currentTarget)[this.type](this._options).data
(this.type) : this;
...
checkPosition, this), 1);
    ...
    a.fn.affix = function(c) {
        return this.each(function() {
            var d = a(this), e = d.data("affix"), f = typeof 
c == "object" && c;
...
(e = c.hasClass("alert") ? c : c.parent()), e.trigger(b = a.Event("close"));
    ...
    b.prototype.setState = function(a) {
        ...
        a += "Text", d.resetText || c.data("resetText"
, c[e]()), c[e](d[a] || this.options[a]), setTimeout(function() {
...
c.closest(".btn")), c.button("toggle");
    ...
    b.prototype = {
        ...
        show: function() {
            ...
            this.$element[b](0), 
this.transition("addClass", a.Event("show"), "shown"), a.support.transition && this.$element[b](this.$element[0][c]);
        },
        hide: function() {
            var b;
            if (this.transitioning || !this.$element.hasClass("in")) return;
        ...
        transition: function(b, c, d) {
            ...
            this.transitioning = 1, this.$element[b]("in"), a.support.transition && 
this.$element.hasClass("collapse") ? this.$element.one(a.support.transition.end, f) : f();
        },
        toggle: function() {
...
b < 0) return;
        ...
        slide: function(b, c) {
            ...
            this.sliding = !0, f && this.pause(), e = 
e.length ? e : this.$element.find(".item")[h](), j = a.Event("slide", {
                relatedTarget: e[0],
                direction: g
            });
...
case 17:
        ...
        mouseleave: function(a) {
            this.mousedover = !1, !this
.focused && this.shown && this.hide();
        }
    };
