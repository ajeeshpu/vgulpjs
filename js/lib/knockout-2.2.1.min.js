...
case "replaceChildren":
        ...
        function V(a, d, c) {
            var e;
            for (d = b.e.nextSibling(d); a && (e = a) !== d; ) a = b.e.nextSibling(e), (1 === e.nodeType || 8 === e.nodeType
) && c(e);
        }
        function W(a, d, c) {
            a = b.g.aa(a);
...
return b.a.f.set(a, da, {}), {
        ...
        b.b = function(a, d) {
            ...
            a[b] = c;
        }, b.version = "2.2.1", b.b("version", b.version), b.a = new 
function() {
            function a(a, d) {
...
: 7 === n,
                ...
                xa: function(a, d, c) {
                    return ("undefined" == typeof JSON || "undefined" == typeof JSON.stringify) && j(Error("Cannot find JSON.stringify(). Some browsers (e.g., IE < 8) don't support it natively, but you can overcome this by adding a script reference to json2.js, downloadable from http://www.json.org/json2.js"
)), JSON.stringify(b.a.d(a), d, c);
                },
                Jb: function(a, d, c) {
                    c = c || {};
            ...
            return a = c.shift(), function() {
                return b
.apply(a, c.concat(Array.prototype.slice.call(arguments)));
            };
        }), b.a.f = new function() {
        ...
        }, b.b("utils.domData", b.a.f), b.b("utils.domData.clear"
, b.a.f.clear), b.a.F = new function() {
            function a(a, d) {
                var e = b.a.f.get(a, c);
        ...
        b.m = function(a) {
            function d() {
                if (0 < arguments.length) {
                    if (!d.equalityComparer || !d.equalityComparer(c, arguments[0])) d.H(), c = arguments[0], 
d.G();
                    return this;
                }
                return b.r.Wa(d), c;
        ...
        b.m.fn[E] = b.m, b.ma = function(a, d) {
            ...
            return "function" == typeof a && a[E] === b.m || "function" == typeof 
a && a[E] === b.j && a.zb ? m : r;
...
w, w = function() {
            ...
            q: function(a) {
                switch (b.a.u(a)) {
                  case "option":
                    return a.__ko__hasDomDataOptionValue__ === m ? b.a.f.get(a, b.c.options.sa) : 7 >= b.a.Z ? a.getAttributeNode("value").specified ? a.value 
: a.text : a.value;
                  case "select":
...
d.charAt(f - 1)) {
            ...
            ba: function(a) {
                ...
                for (var e, f = 0; e = d[f]; f++) if (0 < c.length && c.push(","), e.key) {
                    ...
                    e = e.value, c.push(g), c.push(":"), c.push(e), e = b.a.D(e), 0 <= b.a.i(na, b.a.D(e).toLowerCase()) ? e = r : (h = e.match(oa), e = h === p ? r : h[1] ? "Object(" + h[1] + ")" + h[2] : e), e && (0 < a.length && a.push(", "), a.push(g + " : function(__ko_value) { " + e + " = __ko_value; }"));
        ...
        }, b.b("expressionRewriting", b.g), b.b("expressionRewriting.bindingRewriteValidators", b.g.Q), b.b("expressionRewriting.parseObjectLiteral"
, b.g.aa), b.b("expressionRewriting.preProcessBindings", b.g.ba), b.b("jsonExpressionRewriting", b.g), b.b("jsonExpressionRewriting.insertPropertyAccessorsIntoJson", b.g.ba);
        var K = "<!--test-->" === y.createComment("test").text, ja = K ? /^\x3c!--\s*ko(?:\s+(.+\s*\:[\s\S]*))?\s*--\x3e$/ : /^\s*ko(?:\s+(.+\s*\:[\s\S]*))?\s*$/, ia = K ? /^\x3c!--\s*\/ko\s*--\x3e$/ : /^\s*\/ko\s*$/, pa = {
            ul: m,
            ol: m
        };
        b.e = {
            ...
            N: function(a, d) {
                if (B(a)) {
                    b.e.Y(a);
                    for (var c = a.nextSibling, e = 0, f = d.length; e < f; e++) c.parentNode
.insertBefore(d[e], c);
                } else b.a.N(a, d);
            },
            Va: function(a, b) {
...
, {
            ...
            parseBindingsString: function(a, d, c) {
                try {
                    ...
                    if (!(e = this.Ha[a])) {
                        var f = 
this.Ha, g, h = "with($context){with($data||{}){return{" + b.g.ba(a) + "}}}";
...
a, d) {
        ...
        }, b.b("bindingHandlers", b.c), b.b("applyBindings"
, b.Da), b.b("applyBindingsToDescendants", b.Ea), b.b("applyBindingsToNode", b.Fa), b.b("contextFor", b.ja), b.b("dataFor", b.pb);
        var fa = {
            "class": "className",
            "for": "htmlFor"
        };
...
a.preventDefault() : a.returnValue = r);
                            }
...
(c ? a.focus() : a.blur(), b.r.K(b.a.Ba, p, [ a, c ? "focusin" : "focusout" ]));
            }
        }, b.c.html = {
            init: function() {
                return {
        ...
        Q("if"), Q("ifnot", r, m), Q("with", m, r, function(a, b) {
            ...
            update: function(a, d, c) {
                ...
                }), g = a.scrollTop, h = b.a.d(d()); 0 < 
a.length; ) b.A(a.options[0]), a.remove(0);
                if (h) {
                    c = c();
            ...
            update: function(a, d) {
                ...
                var c = b.a.d(d());
                c && "number" == typeof c.length && b.a.o(a.getElementsByTagName
("option"), function(a) {
...
return a.click = d(), a;
            ...
            return this.allowTemplateRewriting === 
r ? m : this.makeTemplateSource(a, b).data("isRewritten");
...
ia.innerHTML), a.Aa;
        ...
        b.wa = function(a) {
            ...
            if (e) {
                ...
                return b.j(function() {
                    var h = d && 
d instanceof b.z ? d : new b.z(b.a.d(d)), k = "function" == typeof a ? a(h.$data, h) : a, h = T(e, f, k, h, c);
            ...
            return b.j(function() {
                var a = b.a.d(d) || [];
                "undefined" == typeof 
a.length && (a = [ a ]), a = b.a.fa(a, function(a) {
            ...
            update: function(a, d, c, e, f) {
                d = b.a.d(d()), c = {}, e = m;
                var g, h = p;
                "string" != typeof d && (c = d, d = c.name, "if" in c && (e = b.a.d(c["if"])), e && "ifnot" in c && (e = !b.a.d(c.ifnot)), g = b.a.d(c.data)), "foreach" in c ? h = b.Mb(d || a, e && c.foreach || [], c, a, f) : e ? (f = "data" in 
c ? f.createChildContext(g, c.as) : f, h = b.va(d || a, f, c, a)) : b.e.Y(a), f = h, (g = b.a.f.get(a, "__ko__templateComputedDomDataKey__")) && "function" == typeof g.B && g.B(), b.a.f.set(a, "__ko__templateComputedDomDataKey__", f && f.pa() ? f : I);
            }
...
b.C, b.wa(b.C.oa), b.b("nativeTemplateEngine", b.C), b.qa = function() {
