...
(function(Z) {
    ...
    function A(b, c, e, h) {
        return c = Error(c + "\nhttp://requirejs.org/docs/errors.html#" + b), c.requireType = b, c.requireModules = h, e && (c.originalError = e), c;
    }
    function ha(b) {
        function c(a, f, b) {
            ...
            if (a && "." === a.charAt(0)) if (f) {
                d = l(k.pkgs, f) ? i = [ f ] : i.slice(0, i.length - 1), f = a = d.concat(a.split("/"));
                for (d = 0; f[d]; d += 1) if (m = f[d], "." === m) f.splice(d, 1), d -= 1; else if (".." === m) {
...
d = l(k.pkgs, f = a[0]), a = a.join("/"), d && a === f + "/" + d.main && (a = f);
        ...
        function e(a) {
            z && y(document.getElementsByTagName("script"), function(f) {
                if (f.getAttribute("data-requiremodule") === a && f.getAttribute("data-requirecontext") === i.contextName) return f
.parentNode.removeChild(f), !0;
            });
        }
        function h(a) {
            var f = l(k.paths, a);
        ...
        function $(a) {
            ...
            return -1 < b && (f = a.substring(0, b), a = a.substring(b + 1, a.length)), [ f, a ];
        }
        function n(a, f, b, d) {
            var m, B, g = null, e = f ? f.name : null, h = a, j = !0, k = "";
            return a || (j = !1, a = "_@r" + (L += 1)), a = $(a), g = a[0], a = a[1], g && (g = c(g, e, d), B = l(r, g)), a && (g ? k = B && B.normalize ? B.normalize(a, function(a) {
                return c(a, e, d);
            }) : c(a, e, d) : (k = c(a, e, d), a = $(k), g = a[0], k = a[1], b = !0, m = i.nameToUrl(k))), b = g && !B && !b ? "_unnormalized" + (M += 1) : "", {
                prefix: g,
                name: k,
                parentMap: f,
                unnormalized
: !!b,
        ...
        function q(a) {
            var f = a.id, b = l(p, f);
            return b || (b = p[f] = new i.Module(a)), b;
        }
        function s(a, f, b) {
            var d = a.id, m = l(p, d);
            t(r, d) && (!m || m.defineEmitComplete) ? "defined" === f && b(r[d]) : (m = q(a), m.error && "error" === f) ? b(m.error) : m.on(f, b);
        }
        function v(a, f) {
...
var d = a.map.id;
        ...
        function C() {
            ...
            if (!U) {
                ...
                if (m && c.length) return b = A("timeout", "Load timeout for modules: " + c, null, c), b.contextName = i.contextName, v(b);
                l && y(g, function(a) {
                    E
(a, {}, {});
                }), (!m || d) && j && (z || da) && !V && (V = setTimeout(function() {
                    V = 0, C();
                }, 50)), U = !1;
            }
        }
        ...
        function J(a) {
            ...
            return a.detachEvent && !W ? a.detachEvent("onreadystatechange", b) : a.removeEventListener("load", b, !1), b = i.onScriptError, (!a.detachEvent || W) && a.removeEventListener("error", b, !1), {
                node: a,
...
this.defined) {
                                ...
                                this.exports = d, this.map.isDefine && !this.ignore && (r[c] = d, j.onResourceLoad) && j.onResourceLoad(
i, this.map, this.depMaps), x(c), this.defined = !0;
                            }
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(e), s(e, "defined", u(this, function(d) {
                    var m, e;
                    e = this.map.name;
...
d = n(a.prefix + "!" + e, this.map.parentMap), s(d, "defined", u(this, function(a) {
                        ...
                        })), e = l(p, d.id)) this.depMaps.push(d), this.events.error && e.on("error", u(this, function(a) {
                            this.emit("error", a);
                        })), e.enable();
                        ...
                        this.inited = !0, this.error = a, a.requireModules = [ b ], F(p, function(a) {
                            0 === a.map.
id.indexOf(b + "_unnormalized") && x(a.map.id);
                        }), v(a);
                    }), m.fromText = u(this, function(d, c) {
                        var e = a.name, g = n(e), B = O;
                        c && (d = c), B && (O = !1), q(g), t(k.config, b) && (k.config[e] = k.config[b]);
                        try {
                            j.exec(d);
                        } catch (ca) {
            ...
            enable: function() {
                T[this.map.id] = this, this.enabling = this.enabled = !0, y(this.depMaps, u(this, function(a, b) {
                    ...
                    if ("string" == typeof a) 
{
                        a = n(a, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap), this.depMaps[b] = a;
                        if (c = l(N, a.id)) {
...
a = {
                        deps: a
                    }), (a.exports || a.init) && !a.exportsFn && (a.exportsFn = i.makeShimExports(a)), c[b] = a;
            ...
            makeShimExports: function(a) {
                return function() {
                    var b;
                    return a.init && (b = a.init.apply(Z, arguments)), b || a.exports && ba(a.exports);
                };
            ...
            makeRequire: function(a, f) {
                function h(d, c, e) {
                    var g, k;
                    return f.enableBuildCallback && c && H(c) && (c.__requireJsBuild = !0), "string" == typeof d ? H(c) ? v(A("requireargs", "Invalid require call"), e) : a && t(N, d) ? N[d](p[a.id]) : j.get ? j.get(i, d, a, h) : (g = n(d, a, !1, !0), g = g.id, t(r, g) ? r[g] : v(A("notloaded", 'Module name "' + g + '" has not been loaded yet for context: ' + b + (a ? "" : ". Use require([])")))) : (K(), i.nextTick(function() {
                        K(), k = q(n(null, a)), k.skipMap = f.skipMap, k.init(d, c, e, {
                            enabled: !0
                        }), C();
                    }), h);
                }
                return f = f || {}, Q(h, {
                    ...
                    toUrl: function(b) {
                        ...
                        return -1 !== e && ("." !== g && ".." !== 
g || 1 < e) && (f = b.substring(e, b.length), b = b.substring(0, e)), i.nameToUrl(c(b, a && a.id, !0), f, !0);
                    },
                    defined: function(b) {
                        return t(r, n(b, a, !1, !0).id);
                    },
                    specified: function(b) {
                        return b = n(b, a, !1, !0).id, t(r, b) || t(p, b);
                    }
                }), a || (h.undef = function(b) {
                    w();
                    var c = n(b, a, !0), f = l(p, b);
                    e(b), delete r[b], delete S[c.url], delete Y[b], f && (f.events.defined && (Y[b] = f.events), x(b));
                }), h;
            },
            enable: function(a) {
                l(p, a.id) && q(a).enable();
...
c[0] = a;
            ...
            nameToUrl: function(a, b, c) {
                ...
                if (j.jsExtRegExp.test(a)) g = a + (b || ""); else {
                    d = k.paths, e = k.pkgs, g = a.split("/");
                    for (i = g.length; 0 < i; i -= 1) {
                        if (n = g.slice(0, i).join("/"), h = l(e, n), n = l(d, n)) {
                            I(n) && (n = n[0]), g.splice(0, i, n);
                            break;
                        }
                        
if (h) {
                            a = a === h.name ? h.location + "/" + h.main : h.location, g.splice(0, i, a);
                            break;
                        }
                    }
            ...
            onScriptError: function(a) {
                var b = J(a);
                if (!h(b.id)) return v(A("scripterror", "Script error for: " + 
b.id, a, [ b.id ]));
            }
    ...
    if ("undefined" == typeof define) {
        ...
        "undefined" != typeof require && !H(require) && (s = require, require = void 0), j = requirejs = function(b, c, e, h) {
            
var q, n = "_";
            return !I(b) && "string" != typeof b && (q = b, I(c) ? (b = c, c = e, e = h) : b = []), q && q.context && (n = q.context), (h = l(E, n)) || (h = E[n] = j.s.newContext(n)), q && h.configure(q), h.require(b, c, e);
        }, j.config = function(b) {
            return j(b);
            ...
            contexts: E,
            newContext: ha
        }, j({}), y([ "toUrl", "undef", "defined", "specified" ], function(b) {
            j[b] = function() {
                var c = E._;
                return c.require[b].apply(c, arguments);
            };
        }), z && (x = w.head = document.getElementsByTagName("head")[0], C = document.getElementsByTagName("base")[0]) && (x = w.head = C.parentNode), j.onError = aa, 
j.createNode = function(b) {
            ...
            return c.type = b.scriptType || "text/javascript", c.charset = "utf-8", c.async = !0, c;
...
c + " at " + e, l, [ c ]));
            ...
            var h, j;
            "string" != typeof b && (e = c, c = b, b = null), I(c) || (e = c, c = null), !c && H(e) && (c = [], e.length && (e.toString().replace(la, "").replace(ma, function(b, e) {
                c.push(e);
            }), c = (1 === e.length ? [ "require" ] : [ "require", "exports", "module" ]).concat(c))), O && ((h = K) || (P && "interactive" === P.readyState || M(document.getElementsByTagName("script"), function(b) {
                if ("interactive" === b.readyState) return P = b;
            
}), h = P), h && (b || (b = h.getAttribute("data-requiremodule")), j = E[h.getAttribute("data-requirecontext")])), (j ? j.defQueue : R).push([ b, c, e ]);
        }, define.amd = {
            jQuery: !0
        }, j.exec = function(b) {
            return eval(b);
